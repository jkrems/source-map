...
exports.computeSourceURL = exports.relative = exports.join = exports.normalize = exports.parseSourceMapInput = exports.compareByGeneratedPositionsInflated = exports.fromSetString = exports.toSetString = exports.getArg = void 0;
/**
 ...
 */
function toSetStringFallback(aStr) {
    if (isProtoString(aStr)) {
        return "$" + aStr;
    }
    return aStr;
}
exports.toSetString = supportsNullProto ? identity : toSetStringFallback;
function fromSetStringFallback(aStr) {
    if (isProtoString(aStr)) {
        return aStr.slice(1);
    }
    return aStr;
}
exports.fromSetString = supportsNullProto ? identity : fromSetStringFallback;
 ...
 * @return A normalized URL value.
 */
exports.normalize = createSafeHandler((url) => { });
/**
...
function join(aRoot, aPath) {
    ...
    if (pathType === "scheme-relative") {
        return (0, exports.normalize)(aPath);
    }
...
function relative(rootURL, targetURL) {
    ...
    return typeof result === "string" ? result : (0, exports.normalize)(targetURL);
}
...
function relativeIfPossible(rootURL, targetURL) {
    ...
    if (target.protocol !== root.protocol ||
...
function computeSourceURL(sourceRoot, sourceURL, sourceMapURL) {
    ...
    let url = (0, exports.normalize)(sourceURL || "");
