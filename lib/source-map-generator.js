...
const mapping_list_1 = require("./mapping-list");
/**
...
class SourceMapGenerator {
    constructor(aArgs = {}) {
        ...
        this._sources = new array_set_1.ArraySet();
        this._names = new array_set_1.ArraySet();
        this._mappings = new mapping_list_1.MappingList();
    ...
    applySourceMap(aSourceMapConsumer, aSourceFile, aSourceMapPath) {
        ...
        // the names array.
        const newSources = this._mappings.toArray().length > 0 ? new array_set_1.ArraySet() : this._sources;
        const newNames = new array_set_1.ArraySet();
