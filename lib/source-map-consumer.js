...
exports.IndexedSourceMapConsumer = exports.BasicSourceMapConsumer = exports.SourceMapConsumer = void 0;
const util = require("./util");
const binary_search_1 = require("./binary-search");
const array_set_1 = require("./array-set");
const read_wasm_1 = require("./read-wasm");
const wasm_1 = require("./wasm");
const INTERNAL = Symbol("smcInternal");
const SOURCE_MAP_VERSION = 3;
var SourceMappingOrder;
(function (SourceMappingOrder) {
    SourceMappingOrder[SourceMappingOrder["GENERATED_ORDER"] = 1] = "GENERATED_ORDER";
    SourceMappingOrder[SourceMappingOrder["ORIGINAL_ORDER"] = 2] = "ORIGINAL_ORDER";
})(SourceMappingOrder || (SourceMappingOrder = {}));
var SourcePositionBias;
(function (SourcePositionBias) {
    SourcePositionBias[SourcePositionBias["GREATEST_LOWER_BOUND"] = 1] = "GREATEST_LOWER_BOUND";
    SourcePositionBias[SourcePositionBias["LEAST_UPPER_BOUND"] = 2] = "LEAST_UPPER_BOUND";
})(SourcePositionBias || (SourcePositionBias = {}));
class SourceMapConsumer {
    constructor(sourceMap, sourceMapHref) {
    ...
    static initialize(opts) {
        (0, read_wasm_1.initialize)(opts["lib/mappings.wasm"]);
    }
    static fromSourceMap(sourceMap, sourceMapHref) {
    ...
    static get GREATEST_LOWER_BOUND() {
        return SourcePositionBias.GREATEST_LOWER_BOUND;
    }
    static get LEAST_UPPER_BOUND() {
...
class BasicSourceMapConsumer extends SourceMapConsumer {
    constructor(aSourceMap, aSourceMapURL) {
        return super(INTERNAL).then(that => {
            ...
            that._names = array_set_1.ArraySet.fromArray(names.map(String), true);
            that._sources = array_set_1.ArraySet.fromArray(sources, true);
            that._absoluteSources = array_set_1.ArraySet.fromArray(that._sources.toArray().map(function (s) {
            ...
            that._mappingsPtr = 0;
            that._wasm = null;
            return (0, wasm_1.default)().then(w => {
                that._wasm = w;
                return that;
            });
        });
...
class IndexedSourceMapConsumer extends SourceMapConsumer {
    ...
    originalPositionFor(aArgs) {
        ...
        const sectionIndex = binary_search_1.search.search(needle, this._sections, function (aNeedle, section) {
    ...
    generatedPositionFor(aArgs) {
        ...
        if (generatedPosition && generatedPosition.line !== null) {
            ...
            if (generatedPosition.lastColumn === Infinity &&
                nextSection &&
    ...
    eachMapping(aCallback, aContext, aOrder) {
        this._sections.forEach((section, index) => {
            ...
            section.consumer.eachMapping(function (mapping) {
                ...
                if (mapping.lastGeneratedColumn === Infinity &&
                    nextSection &&
